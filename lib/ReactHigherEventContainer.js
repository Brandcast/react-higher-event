...
var ReactHigherEventContainer = function (_Component) {
  ...
  function ReactHigherEventContainer(props) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ReactHigherEventContainer).call(this, props));
  ...
  _createClass(ReactHigherEventContainer, [{
    ...
    value: function update() {
      this.forceUpdate();
      this.proxySubscribers.forEach(function (func) {
        return func();
      });
    }
  }, {
    ...
    value: function getEventProps() {
      ...
      return Array.from(this.events.keys()).reduce(function (acc, key) {
        return _extends({}, acc, _defineProperty({}, key, _this4.handleEvent.bind(null, key)));
      }, {});
    }
  }, {
    key: "getChildContext",
...
ReactHigherEventContainer.childContextTypes = _extends({}, _ReactHigherEventContextTypes2.default, _ReactHigherEventProxyContextTypes2.default);
